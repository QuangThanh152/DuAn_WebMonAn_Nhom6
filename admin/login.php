...
<body>
    <div class="login-container">
        ...
        <form class="form" action="login.php" method="POST">
            <div class="title">Chào mừng,<br><span>Đăng nhập để tiếp tục</span></div>
            <input type="text" placeholder="Username" name="username" class="input" required>
            <input type="password" placeholder="Password" name="password" class="input" required>
            <div class="login-with">
                <div class="button-log">🐱</div>
                <div class="button-log">
                    <svg class="icon" height="56.6934px" viewBox="0 0 56.6934 56.6934" width="56.6934px">
            ...
            <?php flash('login_message'); ?> <!-- Sử dụng hàm flash() -->

            <button type="submit" class="button-confirm">Start Now →</button>
        </form>
    </div>
